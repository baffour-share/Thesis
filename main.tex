...
The software was ran and tested on a laptop with Windows 10, Python, Keras, CUDA (Compute Unified Device Architecture) and CuDNN (CUDA Deep Neural Netowrk) installed. The laptop has web cam support. The software dependencies includes:
\begin{enumerate}
...
% \chapter*{\textbf{Research Results Obtained During the Study for Master Degree}}
